...
results = []
for i, row in tqdm(df.iterrows(), total=len(df), desc="MPNet + TF-IDF eşleştirme"):
...
match_df.to_excel('hibrit_mpnet60_tfidf40_sonuclar.xlsx', index=False)
print("✅ MPNet eşleştirme tamamlandı: hibrit_mpnet60_tfidf40_sonuclar.xlsx")
